...
The exact pre-hardware checkpoint SHA, workflow/run number and payload hashes are recorded in draft PR #1 after its final branch-exact run passes, rather than being embedded here and invalidating themselves with another documentation commit.
