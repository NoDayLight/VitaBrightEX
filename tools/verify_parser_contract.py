...
if "if (opened)" not in lcd or "return ret;" not in lcd:
    errors.append("LCD missing-vs-present authoritative source guard disappeared")
need("oled/parser.c", "if (present) return ret;", "OLED malformed preferred source may fall through")
